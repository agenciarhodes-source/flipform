...
def test_secret_and_singleton_guards():
    ...
    assert 'encryptIntegrationSecret(input.instagramAppSecret)' in service
    assert 'looksMaskedSecret(input.instagramAppSecret)' in service
    assert 'instagramAppSecretMasked: maskSecretFromEncrypted(instagramAppSecretEncrypted)' in service
    ...
    assert 'instagramAppSecretEncrypted:' not in dto
    assert 'instagramAppSecret:' not in dto
