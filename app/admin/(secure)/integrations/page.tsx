...
type Settings = {
  appId: string | null; appSecretConfigured: boolean; appSecretMasked: string | null; redirectUri: string; configured: boolean;
...
export default function AdminIntegrationsPage() {
  ...
  async function save() {
    ...
    const body: Record<string, unknown> = { appId: settings.appId || '', ...Object.fromEntries(presetLabels.map(([key]) => [key, settings[key]])) };
  ...
  return <div className="p-8 space-y-6 max-w-5xl">
    ...
    <Card className="p-6 space-y-6">
      ...
      <p className="text-sm rounded-md bg-blue-50 text-blue-800 p-3">A autorização de contas dos clientes será habilitada na próxima etapa.</p>
