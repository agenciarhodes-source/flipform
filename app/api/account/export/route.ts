...
export const GET = withAuth(async (_req: NextRequest, session) => {
  ...
  await logAudit({ tenantId: session.tenantId, userId: session.userId, entityType: 'account', entityId: session.tenantId, action: 'account.export_requested' });
  ...
  await logAudit({ tenantId: session.tenantId, userId: session.userId, entityType: 'account', entityId: session.tenantId, action: 'account.export_generated' });
