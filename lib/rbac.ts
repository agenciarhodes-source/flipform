...
export const PERMISSIONS = {
  ...
  FORM_DOMAINS_VIEW:    ['owner', 'admin', 'manager', 'agent', 'viewer'] as RoleName[],
  FORM_DOMAINS_CREATE:  ['owner', 'admin', 'manager'] as RoleName[],
  FORM_DOMAINS_EDIT:    ['owner', 'admin', 'manager'] as RoleName[],
  FORM_DOMAINS_DELETE:  ['owner', 'admin'] as RoleName[],
  ...
  REPORTS_VIEW:         ['owner', 'admin', 'manager', 'agent'] as RoleName[],
  REPORTS_VIEW_ALL:     ['owner', 'admin', 'manager'] as RoleName[],
  REPORTS_EXPORT:       ['owner', 'admin', 'manager'] as RoleName[],
  SETTINGS_VIEW:        ['owner', 'admin'] as RoleName[],
  SETTINGS_EDIT:        ['owner', 'admin'] as RoleName[],
  INTEGRATIONS_VIEW:    ['owner', 'admin', 'manager'] as RoleName[],
  INTEGRATIONS_EDIT:    ['owner', 'admin', 'manager'] as RoleName[],
  INTEGRATIONS_TEST:    ['owner', 'admin', 'manager'] as RoleName[],
